...
INSERT INTO question (topic, question, difficulty_id) VALUES ('Java','What is Method Overloading?', 1);  -- 4
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('Method overloading is the ability of a single method to perform more than one 
		task, such as multiple methods with the same name but different parameters.', true, 4);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('Java', 'When would you use a break statement?', 1);  -- 6													   
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('To terminate the current loop or switch statement and transfer control to the 
		statement immediately following the loop or switch.', true, 6);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('Java', 'Define Polymorphism', 1);  -- 7														   
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('A concept in object-oriented programming that allows objects of different types 
		to be processed in a uniform way. It refers to the ability of a variable, function or object to take on multiple forms.', true, 7);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('SQL', 'What is a Primary Key?', 1);  -- 11													  
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('In SQL, a field in a table which uniquely identifies each row/record in a 
		database table.', true, 11);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('SQL', 'What is a Foreign Key?', 1);  -- 12	
	...
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('In SQL, a constraint that forces the values in a column to be unique.',
		 false, 12);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('API', 'What is the difference between a GET and a POST?', 1);  -- 15
	...
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('GET is used to update data on a server, POST is used to retrieve data.', 
		false, 15);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('API', 'When would you use a GET request?', 1);  -- 18
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('To retrieve data from the server without changing anything on the server.', 
		true, 18);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('Java', 'What causes a NullPointerException?', 2);  -- 19
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('Attempting to use or access a reference variable that is currently null.', 
		true, 19);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('Java', 'What is the purpose of the MVC pattern?', 2);  -- 22
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('To separate the concerns of an application into three distinct components: Model, 
		View, and Controller, thereby improving modularity, maintainability, and scalability of the application.', true, 22);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('Java', 'What is an immutable?', 2);  -- 24
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('An object whose state cannot be changed after it is created. This means that 
		once an immutable object is created, its state remains constant throughout its lifetime.', true, 24);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('Java', 'Why is loose coupling important?', 2);  -- 25
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('It reduces the dependencies between components in a system, making it easier to 
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('Java', 'What is serialization/deserialization?', 2);  -- 27
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('Serialization is the process of converting an object into a stream of bytes to 
		store it in memory, a database, or to transmit it over a network. Deserialization is the reverse process, where the serialized byte 
		stream is converted back into an object.', true, 27);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('SQL', 'What is a constraint in SQL?', 2);  -- 29
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('A rule defined on a column or a set of columns that enforces data integrity 
		and ensures that the data stored in the database meets certain criteria. Common types of constraints include primary key, foreign key, 
		unique, not null, and check constraints.', true, 29);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('SQL', 'What is a composite primary key?', 2);  -- 30
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('A composite primary key in a database table consists of two or more columns 
		that uniquely identify each row in the table. Together, these columns form a primary key constraint, ensuring that the combination of 
		values in the specified columns is unique.', true, 30);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('API', 'Why is Login always a POST?', 2);  -- 31
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('It involves sending sensitive information such as usernames and passwords in 
		the request body. Using a POST request allows this information to be encrypted and transmitted securely to the server.', true, 31);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('API', 'What does it mean that HTTP is stateless?', 2);  -- 32
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('It means that the server does not maintain any information about the state of 
		the client between requests. Each request from the client to the server is treated as an independent transaction, and the server does not 
		retain any knowledge of previous interactions with the client.', true, 32);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('API', 'What are the 3 factors of authentication?', 2);  -- 33
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('Something you know (e.g., a password), something you have (e.g., a smartphone 
		or a security token), and something you are (e.g., biometric identifiers like fingerprint or iris scan).', true, 33);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('API', 'What is the difference between authentication and authorization?', 2);  -- 34
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('Authentication is the process of verifying the identity of a user or system. 
		Authorization is the process of determining whether an authenticated user or system has the necessary permissions to access specific 
		resources or perform certain actions within a system.', true, 34);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('API', 'What does a HTTP status 500 mean?', 2);  -- 35
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('It indicates an Internal Server Error. This means that the server encountered 
		an unexpected condition that prevented it from fulfilling the request made by the client.', true, 35);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('API', 'What is a server?', 2);  -- 36
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('A computer program or a device that provides functionality or services to 
		other programs or devices, known as clients, over a network.', true, 36);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('Java', 'What is the difference between a final and immutable?', 3);  -- 38
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('In Java, "final" is a keyword used to declare that a variable can only 
		be assigned once and cannot be reassigned thereafter. This means that the reference to the object pointed to by the final variable 
		cannot change, but the state of the object itself may still be mutable. "Immutable," on the other hand, refers to objects whose 
		state cannot be changed after they are created. Immutable objects guarantee that their state remains constant throughout their 
		lifetime.', true, 38);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('Java', 'What is Autoboxing?', 3);  -- 39
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('The automatic conversion of primitive data types into their corresponding 
		wrapper class objects, and vice versa, by the Java compiler. This allows primitive data types to be used in places where objects are 
		required, such as collections or method parameters that accept objects.', true, 39);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('Java', 'What is a generic?', 3);  -- 40
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('A type that allows classes and methods to operate on objects of various types 
		while providing compile-time type safety. Generics allow you to parameterize classes and methods with one or more types, making them 
		more flexible and reusable.', true, 40);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('Java', 'What is garbage collection?', 3);  -- 41
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('The process in Java where the runtime system automatically deallocates 
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('Java', 'What is the difference between a hash and encryption?', 3);  -- 43
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('A hash function is a one-way mathematical function that converts input data 
		into a fixed-size string of bytes, called a hash value or hash code. Encryption is a two-way process that converts plaintext data into 
		ciphertext using an algorithm and a secret key.', true, 43);
...
INSERT INTO question (topic, question, difficulty_id) VALUES ('Java', 'What is a static method?', 3);  -- 45
	INSERT INTO answer (answer, is_correct, question_id) VALUES ('A method that belongs to the class rather than to any instance of the class. 
		It can be invoked without the need to create an instance of the class, using the class name itself. Static methods are commonly used 
		for utility methods, where the behavior does not depend on the state of any particular object.', true, 45);
