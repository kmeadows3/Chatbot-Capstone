...
-- HARD QUESTIONS
INSERT INTO question (topic, question, difficulty_id) VALUES ('Java', 'Which OO principle says "A class should have only one reason to change, meaning that it should have only one responsibility or job within the system."?', 3);  -- 37
